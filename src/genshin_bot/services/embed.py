...
class CharacterEmbedService(EmbedService):
    ...
    def __init__(self, user: User, character: Character):
        ...
        self.embed = Embed()
        self.default_image = "https://static.wikia.nocookie.net/gensin-impact/images/1/1b/" \
                             "Character_Paimon_Portrait.png/revision/latest?cb=20201205191049"
        self.add_character_info()

    def add_character_info(self):
        self.embed.title = f"Результат ролла {self.user.name}"
